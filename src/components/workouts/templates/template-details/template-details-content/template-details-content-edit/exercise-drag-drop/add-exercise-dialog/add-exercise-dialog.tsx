...
import AddExerciseDialogForm from "@/components/workouts/templates/template-details/template-details-content/template-details-content-edit/exercise-drag-drop/add-exercise-dialog/add-exercise-dialog-form";
