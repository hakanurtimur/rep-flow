...
import UpdateExerciseDialogForm from "@/components/workouts/templates/template-details/template-details-content/template-details-content-edit/exercise-drag-drop/update-exercise-dialog/update-exercise-dialog-form";
