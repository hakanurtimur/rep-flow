...
import TemplatesHeader from "@/components/app/workouts/templates/templates-header";
import TemplateList from "@/components/app/workouts/templates/template-list";
